  ...
  return (
    <div className="about-container about" id="about">
        ...
        <div className="about-bio">
          <p className="bio">I am a Front End Developer specializing in React, Redux, and JavaScript. Using these skills, I have created several projects such as: a Monopoly money tracking web app, the official website for the band Waterfront, a PokeDex using the PokeAPI, a static wedding website acting as a landing page for guests to get info, view the registry, and rsvp, as well as several smaller projects intended as practice opportunities for learning new skills. 
          ...
          <p className="bio">
          In addition to my main focuses, I have explored additional topics including: Firebase/Firestore, Node.js, SQL, PostgreSQL, Express.js, C, Vue.js, Phaser.js, and Cyber Security to name a few. 
          </p>
          ...
          <p className="bio">I possess a B.A. degree in music from the University of Lethbridge and a Music Diploma in percussion from Red Deer Polytechnic. In these programs I learned valuable skills such as: time management, project coordination, and collaborating with a team.
