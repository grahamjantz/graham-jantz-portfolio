  ...
  return (
    <div className="about-container about" id="about">
        ...
        <div className="about-bio">
          ...
          <p className='bio'>Reach out to me via email at <a style={aStyle} href='mailto:grahammrjantz@gmail.com'>grahammrjantz@gmail.com</a> or connect on LinkedIn to chat further about our shared interests and potential collaborations.</p>
